...
struct Stg_DeMarker_EURUSD_M15_Params : Stg_DeMarker_Params {
  Stg_DeMarker_EURUSD_M15_Params() {
    symbol = "EURUSD";
    tf = PERIOD_M15;
    DeMarker_Period = 2;
